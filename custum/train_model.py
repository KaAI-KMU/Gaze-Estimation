...
from dataloader import EstimationFileDataset
...
class TrainEstimationModel(pl.LightningModule):
    def __init__(self, hparams, train_subjects, validate_subjects, test_subjects):
        ...
        _models = {
            "vgg16" : partial(GazeEstimationModel_vgg16, num_out = _param_num.get(hparams._loss_fn)),
            "resnet18" : partial(GazeEstiamationModel_resent18, num_out = _param_num.get(hparams._loss_fn)),
            "preactresnet" : partial(GazeEstimationPreactResnet, num_out = _param_num.get(hparams._loss_fn))
        }
    ...
    def train_dataloader(self):
        ...
        _data_train = EstimationFileDataset(h5_file=h5py.File(self.hparams.hdf5_file, mode="r"),
...
if __name__ == "__main__":
    ...
    _root_parser.add_argument('--hdf5_file', type=str,
                              default=os.path.abspath(os.path.join(root_dir, "./kaAI_dataset.hdf5")))
